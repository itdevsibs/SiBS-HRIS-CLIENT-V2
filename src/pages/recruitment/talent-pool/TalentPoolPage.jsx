...
import {
  ...
  MoveToPipelineModal,
  UpdateStatusModal,
} from "../../../components/modals/talentPool/TalentPoolModal";
          ...
          <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
            <div className="min-w-0">
              ...
              <p className="text-sm text-sibs-tertiary-5">
                Talent Pool stores the master candidate profile. Moving to Pipeline
                creates a separate application record.
              </p>
            </div>
