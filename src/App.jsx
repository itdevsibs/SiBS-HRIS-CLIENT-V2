...
function AppShell({ children }) {
  return (
    <Providers>
      <div className="flex h-screen min-h-0 w-screen overflow-hidden bg-[var(--sibs-tertiary-10)]">
        <ConditionalSidebar />

        <main className="min-h-0 min-w-0 flex-1 overflow-hidden bg-[var(--sibs-tertiary-10)]">
          {children}
        </main>
      </div>
      ...
      <AppShell>
        <Routes>
          ...
          <Route
            ...
            element={<TADashboardPage />}
          />
          <Route
            path="/recruitment/hiring-needs"
            element={<HiringNeedsPage />}
          />
          <Route
