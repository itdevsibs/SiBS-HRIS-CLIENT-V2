...
export default function OMWeeklyMovement({ movement = {}, delay = 0 }) {
  const stages = [
    { key: "Sourced", count: Number(movement.sourced || 0) },
    { key: "Screened", count: Number(movement.screened || 0) },
    { key: "Interviewed", count: Number(movement.interviewed || 0) },
    { key: "Offered", count: Number(movement.offered || 0) },
    { key: "Accepted", count: Number(movement.accepted || 0) },
    { key: "Hired", count: Number(movement.hired || 0) },
  ];
