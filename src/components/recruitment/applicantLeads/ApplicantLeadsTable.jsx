                    ...
                    <td className="px-3 2xl:px-4 py-2 2xl:py-2.5 align-middle">
                      <div className="min-w-0 space-y-0.5">
                        ...
                        <div className="flex min-w-0 items-center gap-1.5">
                          ...
                          <span
                            title={lead.email || ""}
                            className="max-w-[185px] truncate text-[10px] 2xl:text-[11px] font-medium text-sibs-text-muted"
                          >
                            {email}
                          </span>
                        </div>
                    ...
                    <td className="px-3 2xl:px-4 py-2 2xl:py-2.5 align-middle">
                      <div className="min-w-0">
                        ...
                        <p
                          ...
                          className="mt-0.5 max-w-[280px] truncate text-[10px] 2xl:text-[11px] font-medium text-sibs-text-muted"
                        >
                          <span className="font-bold text-sibs-text-faint">Account:</span>{" "}
                          {account}
                        </p>
                      </div>
                    </td>
