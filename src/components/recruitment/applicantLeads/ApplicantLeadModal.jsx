...
import { Check, ChevronDown, UserCheck, UserPlus, X } from "lucide-react";
        ...
        <form onSubmit={handleSaveLead} className="flex max-h-[78vh] flex-col">
          ...
          <div className="shrink-0 border-t border-[#E6ECF2] bg-white px-6 py-4">
            ...
            <button
              type="submit"
              disabled={isSaving}
              className="inline-flex h-10 items-center justify-center gap-2 rounded-xl bg-[#042C51] px-6 text-xs font-extrabold text-white shadow-sm transition hover:bg-[#073A6B]"
            >
