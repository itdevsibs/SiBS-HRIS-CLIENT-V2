...
export default function RecruitmentSettingsTabs({
  ...
  return (
    <section className="overflow-hidden rounded-2xl border border-[#E6ECF2] bg-white shadow-sm">
      <div className="flex min-w-0 gap-2 overflow-x-auto p-2 sibs-scrollbar">
        {tabs.map((tab) => {
          ...
          return (
            <button
              ...
              className={`inline-flex h-10 shrink-0 items-center justify-center gap-2 rounded-xl border px-3 text-xs font-extrabold transition ${
                isActive
