        ...
        <footer className="shrink-0 border-t border-[#DDE5EE] bg-[#F1F5F9] px-5 py-3 2xl:py-3.5 sm:px-6 font-jakarta">
          <div className="flex flex-col-reverse gap-2 sm:flex-row sm:items-center sm:justify-between">
            <button
              type="button"
              onClick={handleCopy}
              className="inline-flex h-8.5 2xl:h-10 items-center justify-center gap-1.5 rounded-lg bg-[#042C51] px-3.5 2xl:px-4 sibs-text-xs font-extrabold text-white shadow-sm transition hover:bg-[#FF5C28] active:scale-[0.98]"
            >
            ...
            <div className="flex flex-col-reverse gap-2 sm:flex-row">
              ...
              {typeof onExport === "function" ? (
                <button
                  type="button"
                  onClick={onExport}
                  className="inline-flex h-8.5 2xl:h-10 items-center justify-center gap-1.5 rounded-lg border border-[#D6DEE8] bg-white px-3.5 2xl:px-4 sibs-text-xs font-extrabold text-[#042C51] transition hover:bg-[#F8FAFC] active:scale-[0.98]"
                >
                  <Download size={14} />
                  Export TXT
                </button>
