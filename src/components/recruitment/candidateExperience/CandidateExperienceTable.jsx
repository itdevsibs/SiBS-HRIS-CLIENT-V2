          ...
          <thead className="bg-[#F8FAFC]">
            <tr className="border-b border-[#E6ECF2]">
              {[
                ...
                <th
                  key={label}
                  className="px-4 py-3 text-[10px] font-extrabold uppercase tracking-wider text-[#042C51]"
                >
                  {label}
                </th>
              ))}
              ...
              paginatedRecords.map((record) => (
                ...
                >
                  <td className="px-4 py-3 align-middle">
                    ...
                    <p className="mt-0.5 max-w-[220px] truncate text-[10px] font-semibold font-mono text-[#667085]">
                      {record.candidateEmail || record.candidateId || "—"}
                    </p>
                  </td>
                  <td className="px-4 py-3 align-middle">
                    <p className="text-xs font-extrabold text-[#042C51]">{record.roleTitle || "—"}</p>
                    <p className="mt-0.5 text-[10px] font-normal uppercase tracking-tight text-[#667085]">
                      {record.account || "—"}
                    </p>
                  </td>
                  <td className="px-4 py-3 align-middle">
                  ...
                  <td className="px-4 py-3 align-middle text-xs font-medium text-[#344054]">
                    {record.finalStage || "—"}
                  </td>
                  <td className="px-4 py-3 align-middle">
                  ...
                  <td className="px-4 py-3 align-middle">
                    <span className="inline-flex items-center gap-1.5 whitespace-nowrap font-mono text-[10px] font-semibold text-[#667085]">
