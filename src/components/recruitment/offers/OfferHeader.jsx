...
export default function OfferHeader({
  ...
  return (
    <section className="sibs-page-header-in sibs-page-card-in sibs-card relative overflow-hidden p-5 font-jakarta sm:p-6">
      ...
      <div className="mt-1 flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
        <div className="min-w-0 space-y-1.5">
          ...
          <p className="max-w-6xl text-xs font-semibold leading-relaxed text-[#667085] sm:text-sm">
